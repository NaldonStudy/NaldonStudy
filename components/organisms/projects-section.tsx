...
const projectsData: Project[] = [
  ...
  },
  {
    ...
    details: {
      ...
      features: [
        ...
        'Nimbus JOSE/JWT를 활용한 디바이스 바인딩 인증 및 리프레시 토큰 화전(RTR) 구현',
  ...
  },
  {
    ...
    details: {
      fullDescription: '약속 시간 조율부터 실제 만남까지의 모든 과정을 하나의 서비스에서 관리할 수 있는 실시간 협업 플랫폼입니다. 백엔드 팀장으로서 실시간 위치 공유 리더보드, 비트마스크 기반 일정 조율 알고리즘, STOMP 기반 채팅 시스템 등 핵심 도메인 로직 설계를 주도했습니다. 특히 대규모 실시간 데이터 처리를 위해 Redis와 SFU 기반 WebRTC 아키텍처를 도입하여 성능을 최적화했습니다.',
      features: [
